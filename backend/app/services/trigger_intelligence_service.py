    ...
    forecast_timeline_24h = [
        {
            ...
            "risk_score": min(65, max(15, risk_score - 30)),
            "risk_level": "LOW",
            "key_hazard": f"Dopamine scrolling on {primary_dev} in bed",
            "shield_protocol": "Feet on floor immediately; hydrate with cold water",
            "is_current": 6 <= current_hour < 12,
        },
        {
            "id": "slot-midday",
            "time_label": "12:00 PM - 06:00 PM",
            "period_name": "Midday Slump",
            "risk_score": min(75, max(35, risk_score - 15)),
            "risk_level": "MODERATE",
            "key_hazard": "Mental fatigue & idle screen downtime",
            "shield_protocol": "Step away from desk; 5-min walk or quick breathwork",
            "is_current": 12 <= current_hour < 18,
        },
        {
            "id": "slot-evening",
            "time_label": "06:00 PM - 10:00 PM",
            "period_name": "Evening Quarantine",
            "risk_score": min(88, max(55, risk_score + 5)),
            "risk_level": "ELEVATED",
            "key_hazard": "Willpower drain & solitary sofa scrolling",
            "shield_protocol": "Bright ambient light; phone on charger across room",
            "is_current": 18 <= current_hour < 22,
        },
        {
            "id": "slot-night",
            "time_label": "10:00 PM - 02:00 AM",
            "period_name": "Bedside Solitude",
            "risk_score": min(96, max(80 if is_post_relapse else 68, risk_score + 12)),
            "risk_level": "CRITICAL",
            "key_hazard": "Dark room solitude with screen in hand",
            "shield_protocol": "Strict device curfew; charge phone 10ft from bed",
