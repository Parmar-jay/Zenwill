                ...
                <View style={styles.chipRow}>
                  {ENERGY_OPTS.map((o) => {
                    ...
                    return (
                      ...
                      >
                        <Ionicons name={o.icon as any} size={14} color={active ? '#00A8FF' : 'rgba(255,255,255,0.4)'} />
                        <ThemedText style={[styles.chipText, active && styles.chipTextActive]}>{o.label}</ThemedText>
                      </TouchableOpacity>
                    );
                  })}
                ...
                <LinearGradient colors={['#00A8FF', '#0052D4']} start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }} style={styles.btnPrimaryGradient}>
                  {isSubmitting ? (
                    <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center' }}>
                      ...
                      <ThemedText style={styles.btnPrimaryText}>Saving Assessment...</ThemedText>
                    </View>
                  ) : (
...
const styles = StyleSheet.create({
  ...
  contentContainer: { paddingHorizontal: Spacing.four, paddingBottom: Spacing.five, paddingTop: 4 },
  ...
  sliderBadge: {
    ...
    backgroundColor: 'rgba(0,168,255,0.12)', borderWidth: 1, borderColor: 'rgba(0,168,255,0.3)',
  },
  sliderBadgeText: { color: '#00A8FF', fontSize: 12, fontWeight: '700' },
  ...
  sliderStepActive: { backgroundColor: 'rgba(0,168,255,0.15)', borderColor: '#00A8FF' },
  sliderStepText: { color: 'rgba(255,255,255,0.3)', fontSize: 12, fontWeight: '600' },
  sliderStepTextActive: { color: '#00A8FF', fontWeight: '700' },
  // Mood
  ...
  emojiCardActive: { borderColor: '#00A8FF', backgroundColor: 'rgba(0,168,255,0.08)' },
  emoji: { fontSize: 22 },
  emojiLabel: { color: 'rgba(255,255,255,0.4)', fontSize: 10, fontWeight: '500' },
  emojiLabelActive: { color: '#00A8FF', fontWeight: '700' },
